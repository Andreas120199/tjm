                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?=$nopolisi;?></td>
                                            <td><img src="<?php echo $foto_mobil;?>" alt="Foto Mobil" style="width:250px;height:250px;"></td>
                                            <td><img src="<?php echo $foto_norangka;?>" alt="Foto No Rangka" style="width:250px;height:250px;"></td>
                                            <td><img src="<?php echo $foto_nomesin;?>" alt="Foto No Mesin" style="width:250px;height:250px;"></td>
                                            <td><img src="<?php echo $foto_stnk;?>" alt="Foto STNK" style="width:250px;height:250px;"></td>
                                            <td><img src="<?php echo $foto_bpkb;?>" alt="Foto BPKB" style="width:250px;height:250px;"></td>
